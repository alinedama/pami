...
export name='Aline Damazio'
export email="alinedamafeijo@gmail.com"
export repositorio="https://github.com/alinedama/pami.git";

#Daqui pra baixo mexa somente se for realmente necessário ou se souber o que está fazendo :P

export branch_name="aula-2023-09-13"
